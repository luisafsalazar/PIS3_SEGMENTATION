...
if __name__ == "__main__":
    ...
    # Configurar para trabajar con BRATS2021
    config.is_brats2021 = True  # Aseguramos que BRATS2021 esté habilitado
    config.is_brain2019 = False  # Deshabilitamos brain2019
    config.is_hepatic_vessel2021 = False  # Deshabilitamos hepatic_vessel2021

    if config.is_brats2021 == True:
        config = config.brats2021
        data_flag = "brats2021"
        is_HepaticVessel = False  # Aseguramos que la variable para HepaticVessel sea False
